...
class fragment_testResult : Fragment() {
    ...
    override fun onCreateView(
        ...
        val chart = view0.findViewById<PieChart>(R.id.dosha_result_diagram)
    ...
    fun viewBindResultDoshaFromBungle(pieChart: PieChart){
        val arrayListPie = arrayListOf<PieEntry>(PieEntry(10f,"10"),PieEntry(20f,"20"),PieEntry(40f,"40"))
        val pieDataSet = PieDataSet(arrayListPie,"Состояние Дош")
        ...
        pieDataSet.apply {
            sliceSpace = 3f
            selectionShift = 5f
            setColors(Color.BLUE,Color.CYAN,Color.GREEN)
        }
